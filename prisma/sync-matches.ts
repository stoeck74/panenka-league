...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // pour détecter les transitions vers FINISHED (déclencheur recalcul points)
    ...
    // ============================================
    // ÉTAPE 5 — Recalcul des points (TODO)
    // ============================================
    // À activer quand src/lib/actions/recalculate-points.ts sera prêt :
    // if (matchesNewlyFinished > 0) {
    //   const pointsResult = await recalculatePoints()
    //   if (pointsResult.ok) {
    //     log.push(`✓ ${pointsResult.predictionsUpdated} pronos recalculés`)
    //   } else {
